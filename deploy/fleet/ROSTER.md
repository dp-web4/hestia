...
| 2 | Sprout     | Linux aarch64 (Jetson) | aarch64-unknown-linux-gnu      | ✅      | ⬜      | ✅         | Rebuilt from source after JetPack 7.2 reinstall (2026-06-24, Rust 1.96, 5m16s, g9e62894). Daemon restored on loopback :7711, dashboard 200. New vault identity post-wipe — Claude Code plugin + hub re-onboarding pending. |
