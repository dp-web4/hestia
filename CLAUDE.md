...
**Inspectable evidence, not prescribed trust (web4 LCT spec §1.2).** A surface's job is to make the
...
decide; do not smuggle in an exclude/admit verdict (the society-ratchet `satisfied_by` bug, 2026-07-16:
it was framed as "the act gate — exercisable only when true," which inverts what web4 is).
