...
mod tests {
    ...
    async fn a_claimed_row_carries_the_attempted_act_and_the_outcome_join_key() {
        ...
        // attempt claims.
        open_and_sovereign_approve(&shared, &session, "pre_tool_use.py").await;
        ...
        let claimed = tool_gate_escalation_claim(
            ...
            &json!({
                ...
                "tool_name": "Edit",
                "marker": "pre_tool_use.py",
                "reason": "Edit -> pre_tool_use.py (re-issued, claiming the approval)",
        ...
        assert_eq!(
            d["attempted_act"], "Edit -> pre_tool_use.py (re-issued, claiming the approval)",
